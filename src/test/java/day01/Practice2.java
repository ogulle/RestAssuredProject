...
//        import static org.hamcrest.Matchers.*;
        ...
        assertThat(firstName , is("Osman"));
        assertThat(lastName , is("Gulle"));
        assertThat(firstName + " " + lastName , is(equalTo("Osman Gulle")));
        ...
        assertThat(firstName , equalToIgnoringCase("osman") );
        assertThat(firstName + lastName , equalToCompressingWhiteSpace("OsmanGulle"));
